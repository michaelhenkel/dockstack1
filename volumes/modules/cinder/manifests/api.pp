...
class cinder::api (
  ...
  cinder_config { 'keystone_authtoken/auth_uri': value => $auth_uri; }
  cinder_config { 'keystone_authtoken/identity_uri': value => $identity_uri; }
  ...
  if $keystone_enabled {
    ...
    cinder_config {
      ...
      #'keystone_authtoken/service_port':      value => $service_port;
